  ...
  return (
    <>
      <section className="gi-cart-section padding-tb-40">
        <h2 className="d-none">Carrito</h2>
        <div className="container">
          {cartItems.length === 0 ? (
            ...
            >
              {" "}
              Agregue un artículo en un carrito.
            </div>
          ) : (
            <div className="row">
              {/* <!-- Sidebar Area Start --> */}
                ...
                <div className="gi-sidebar-wrap">
                  ...
                  <div className="gi-sidebar-block">
                    ...
                    <div className="gi-sb-block-content">
                      <h4 className="gi-ship-title">Estimación de envío</h4>
                      <div className="gi-cart-form">
                        <p>Ingrese su destino para obtener una estimación de envío</p>
                    ...
                    <div className="gi-sb-block-content">
                      <div className="gi-cart-summary-bottom">
                        <div className="gi-cart-summary">
                          ...
                          <div>
                            <span className="text-left">Cargos de elivery</span>
                            <span className="text-right">
                              ${vat.toFixed(2)}
                            </span>
                          </div>
                ...
                >
                  <React.Fragment>
                    <h2 className="gi-title">
                      Nuevo <span>Recien llegados</span>
                    </h2>
