          ...
          <div className="tab-content  gi-single-pro-tab-content">
            ...
            >
              <div className="gi-single-pro-tab-moreinfo">
                ...
                <ul>
                  <li>
                    <span>Modelo</span> SKU140
                  </li>
                  <li>
                    <span>Volumen</span> 500 g
                  </li>
                  <li>
                    <span>Dimensionones</span> 35 × 30 × 7 cm
                  </li>
                  <li>
                    <span>Marca</span> Toyota, BMW, Tesla, Mercedes
                  </li>
                  <li>
                    <span>Tamaño</span> 10 X 20
                  </li>
                </ul>
              </div>
            </Fade>
              ...
              <div className="gi-single-pro-tab-moreinfo">
                <div className="gi-product-vendor">
                  ...
                  <div className="gi-detail">
                    <ul>
                      <li>
                        <span>Número:</span> +57 3150528878
                      </li>
                      <li>
                        <span>Número:</span> +57 3125316550
                      </li>
                      <li>
                        <span>Email:</span> heady_melo@soy.sena.edu.co
                      </li>
                      <li>
                        <span>Email:</span> esteban_ricardo@soy.sena.edu.co
                      </li>
                      <li>
                        <span>Dirección:</span> SENA CIMM
                      </li>
                    </ul>
                    <p>
                      Lorem Ipsum is simply dummy text of the printing and
            ...
            >
              {!login ? (
                <div className="container">
                  <p>
                    Porfavor <a href="/login">Inicia sesion</a> o{" "}
                    <a href="/register">registrate</a> para revisar el producto.
                  </p>
                </div>
              ) : (
                <div className="row">
