                ...
                <Col sm={12} lg={3}>
                  ...
                  >
                    <div className="gi-footer-widget gi-footer-company">
                      ...
                      Automanage es tu destino seguro para repuestos y reparaciones. Tenemos los componentes que necesitas, desde empaquetaduras hasta bombas de combustible, con calidad garantizada. ¡Todo en un solo lugar!.
                      </p>
                        ...
                        >
                          <ul className="align-itegi-center">
                            ...
                            <li className="gi-footer-link gi-foo-call">
                              ...
                              <a href="tel:+57 3125316550">+57 3125316550</a>
                            </li>
                            <li className="gi-footer-link gi-foo-call">
                              <span>
                                <i className="fi fi-brands-whatsapp svg_img foo_svg"></i>
                              </span>
                              <a href="tel:+57 3150528878">+57 3150528878</a>
                            </li>
                            <li className="gi-footer-link gi-foo-mail">
                              <span>
                                <i className="fi fi-rr-envelope"></i>
                              </span>
                              <a href="esteban_ricardo@soy.sena.edu.co">
                            ...
                            <li className="gi-footer-link gi-foo-mail">
                              ...
                              <a href="heady_melo@soy.sena.edu.co">
                  ...
                  <div className="footer-copy">
                    <div className="footer-bottom-copy ">
                      <div className="gi-copy">
                        ...
                        Todos los derechos reservados. Desarrollado por Automanage.
                      </div>
                    </div>
                  </div>
