            ...
            >
              <div className="gi-category-menu">
                <div className="gi-category-toggle">
                  ...
                  <span className="text">Todas las categorías</span>
                  <i
                    ...
                    <div className="row gi-location-wrapper">
                      <ul className="loc-grid">
                        ...
                        <li className="loc-list">
                          <i className="fi fi-rr-map-marker-plus"></i>
                          <span className="gi-detail">Colombia</span>
                        </li>
                        <li className="loc-list">
                          <i className="fi fi-rr-map-marker-plus"></i>
                          <span className="gi-detail">Mexico</span>
                        </li>
                        <li className="loc-list">
                          <i className="fi fi-rr-map-marker-plus"></i>
                          <span className="gi-detail">Estados Unidos</span>
                        </li>
                        <li className="loc-list">
                          <i className="fi fi-rr-map-marker-plus"></i>
                          <span className="gi-detail">Argentina</span>
                        </li>
                        <li className="loc-list">
                          <i className="fi fi-rr-map-marker-plus"></i>
                          <span className="gi-detail">Ecuador</span>
                        </li>
                      </ul>
                    </div>
                  </div>
