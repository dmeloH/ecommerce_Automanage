        ...
        <div className="container">
          <div className="section-title-2">
            <h2 className="gi-title">
              Productos <span>Deseados</span>
            </h2>
            <p>Su deseo sobre el producto es nuestra primera prioridad.</p>
          </div>
          {wishlistItems.length === 0 ? (
            <h4 className="text-center">Tu lista de deseos está vacía.</h4>
          ) : (
            <Row>
              <Col md={12}>
