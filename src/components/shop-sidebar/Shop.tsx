            ...
            <div className="col-md-6 gi-sort-select">
              <div className="gi-select-inner">
                ...
                >
                  ...
                  <option value="6">Precio, de mayor a menor</option>
                </select>
              </div>
            </div>
          </div>
            ...
            >
              ...
              {!data.data.length ? (
                ...
                <div className="gi-pro-pagination">
                  <span>
                  Demostración {(currentPage - 1) * itemsPerPage + 1}-
                    {Math.min(currentPage * itemsPerPage, data.totalItems)} de{" "}
                    {data.totalItems} elemento(s)
                  </span>
