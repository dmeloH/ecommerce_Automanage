        ...
        <div id="shop_sidebar">
          <div className="gi-sidebar-wrap">
            ...
            <div className="gi-sidebar-block">
              ...
              >
                <h3 className="gi-sidebar-title">Categoría</h3>
                <div
            ...
            <div className="gi-sidebar-block">
              <div className="gi-sb-title">
                <div
                  style={{ display: "flex", justifyContent: "space-evenly" }}
                >
                  <h3 className="gi-sidebar-title">Calidad</h3>
                  <div
                    style={{ cursor: "pointer" }}
            ...
            <div className="gi-sidebar-block">
              <div
                ...
                className="gi-sb-title"
              >
                <h3 className="gi-sidebar-title">Precio</h3>
                <div
                  style={{ cursor: "pointer" }}
            ...
            <div className="gi-sidebar-block">
              <div
                ...
                className="gi-sb-title"
              >
                <h3 className="gi-sidebar-title">Marca</h3>
                <div
                  style={{ cursor: "pointer" }}
