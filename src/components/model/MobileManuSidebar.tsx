      ...
      {isMobileMenuOpen && (
        <div id="gi-mobile-menu" className="gi-mobile-menu gi-menu-open">
          <div className="gi-menu-title">
            <span className="menu_title">Mi Menu</span>
                        ...
                        <Collapse in={activeSubMenu === "Banner"} >
                          <ul style={{ display: activeSubMenu === "Banner" ? "block" : "none" }} className="sub-menu height-transition-1s-ease">
                            {banner.map((data, index) => (
                              <li key={index}>
                                <Link href={data.href}>Estandarte {data.name}</Link>
                              </li>
                            ))}
                          </ul>
                        </Collapse>
                  ...
                  <Collapse in={activeMainMenu === "Products"} >
                    <ul style={{ display: activeMainMenu === "Products" ? "block" : "none" }} className="sub-menu height-transition-1s-ease">
                      <li>
                        ...
                        <a onClick={() => toggleSubMenu("product")} href="#">Página de productos</a>
                        <Collapse in={activeSubMenu === "product"} >
                          <ul style={{ display: activeSubMenu === "product" ? "block" : "none" }} className="sub-menu height-transition-1s-ease">
                            <li><a href="/product-left-sidebar">Barra lateral izquierda del producto</a></li>
                            <li><a href="/product-right-sidebar">Barra lateral derecha del producto</a></li>
                          </ul>
                        </Collapse>
                      </li>
                      <li>
                        ...
                        <a onClick={() => toggleSubMenu("productAccordion")} href="#">Acordeón de productos</a>
                        <Collapse in={activeSubMenu === "productAccordion"} >
                          <ul style={{ display: activeSubMenu === "productAccordion" ? "block" : "none" }} className="sub-menu height-transition-1s-ease">
                            <li><a href="/product-according-left-sidebar">Barra lateral izquierda</a></li>
                            <li><a href="/product-according-right-sidebar">Barra lateral derecha</a></li>
                          </ul>
                        </Collapse>
                      </li>
                      <li>
                        <Link href="/product-full-width">Ancho completo del producto</Link>
                      </li>
                      <li>
